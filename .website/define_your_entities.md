...
All three annotations also support an optional `utc` parameter that allows you to specify whether to use UTC time for the timestamps. By default, Loxia does not use UTC time, but you can enable it by setting `utc: true` in the annotation.
